...
import pyodbc
from interfaz_citisalud.config import SQL_SERVER, SQL_DATABASE, SQL_USERNAME, SQL_PASSWORD
...
def tomar_nombre_usuario(lista):
    ...
    persona = lista[0]
    nombre_completo = f"{persona['Nombre1'].strip()} {persona['Nombre2'].strip()} {persona['Apellido1'].strip()} {persona['Apellido2'].strip()}"
